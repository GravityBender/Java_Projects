...
public class ShiftCipher implements ReadFromFile, WriteToFile {

    File filename;

    public ShiftCipher() {
        this.filename = new File("Demo.txt");
    }

    public ShiftCipher(String name) {
    ...
    private void encrypt(String lines) {
    ...
    public void writeFile(String word) {
        Path filePath = FileSystems.getDefault().getPath("ShiftCipher.txt");
